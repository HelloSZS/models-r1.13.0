...
python export_tflite_ssd_graph.py --pipeline_config_path images/object/ssd_mobilenet_v2_coco.config --trained_checkpoint_prefix images/ckpt/model/model.ckpt-200000 --output_directory images/ckpt/model/
